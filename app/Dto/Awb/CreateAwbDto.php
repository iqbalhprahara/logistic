...
class CreateAwbDto extends Data
{
    ...
    public static function fromImport(ImportDetail $importDetail)
    {
        ...
        return static::validateAndCreate([
            ...
            'origin_contact_phone' => strval($dataOptionalCheck['telepon_pengirim']),
            'origin_contact_alt_phone' => $dataOptionalCheck['telepon_pengirim_alternatif'] ? strval($dataOptionalCheck['telepon_pengirim_alternatif']) : null,
            ...
            'destination_contact_phone' => strval($dataOptionalCheck['telepon_penerima']),
            'destination_contact_alt_phone' => $dataOptionalCheck['telepon_penerima_alternatif'] ? strval($dataOptionalCheck['telepon_penerima_alternatif']) : null,
