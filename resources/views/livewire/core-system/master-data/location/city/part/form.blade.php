<div class="mb-3 position-relative">
    ...
    <select
        ...
        placeholder="Select Province" wire:model.lazy="city.province_id" style="width:100%" required>
        @if ($provinceOptions)
...
<div class="mb-3 position-relative">
    ...
    <select
        ...
        placeholders="Select City Type" wire:model.lazy="city.type" style="width:100%" required>
        @if ($cityTypeOptions)
