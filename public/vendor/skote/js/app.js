...
/*!******************************************!*\
  !*** ./resources/vendor/skote/js/app.js ***!
  \******************************************/
/*
...
(function ($) {
  ...
  function initBreadcrumb() {
    breadcrumb(document.querySelector('.metismenu a.active'));
  }
  ...
  function breadcrumb(el) {
    ...
    if (parent.classList.contains('metismenu')) {
      return;
    }
    ...
    if (parent.nodeName === 'LI' && !el.classList.contains('active')) {
      ...
      var title = anchor.querySelector('.title');
    ...
    if (el.classList.contains('active')) {
      var item = el.querySelector('a > .title');
