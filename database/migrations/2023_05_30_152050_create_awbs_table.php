...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('awbs', function (Blueprint $table) {
            ...
            $table->string('origin_zipcode', 10)->nullable();
            $table->string('origin_contact_name');
            $table->string('origin_contact_phone');
            $table->string('origin_contact_alt_phone')->nullable();
            ...
            $table->string('destination_zipcode', 10)->nullable();
            $table->string('destination_contact_name');
            $table->string('destination_contact_phone');
            $table->string('destination_contact_alt_phone')->nullable();

            $table->unsignedTinyInteger('package_koli');
            $table->unsignedDecimal('package_weight');
            $table->unsignedDecimal('package_length');
            $table->unsignedDecimal('package_width');
            $table->unsignedDecimal('package_height');
            $table->text('package_desc')->nullable();
            $table->unsignedDecimal('package_value', 20, 2)->nullable();
            $table->text('package_instruction')->nullable();
